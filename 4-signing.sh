...
tput setaf 2
    echo "--> Alice creating digest" ; read -n1 -s
tput sgr0
sha256sum alice/plaintext | awk '{print $1}' > alice/digest
cat alice/digest

tput setaf 2
    echo "--> Alice sign digest" ; read -n1 -s
tput sgr0
...
tput setaf 2
    echo "--> Bob verify signature" ; read -n1 -s
tput sgr0
...
tput setaf 2
    echo "--> Bob create digest" ; read -n1 -s
tput sgr0
sha256sum bob/plaintext | awk '{print $1}' > bob/digest
cat bob/digest

tput setaf 2
    echo "--> Bob verify message integrity" ; read -n1 -s
tput sgr0
